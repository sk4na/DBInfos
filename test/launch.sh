...
########################## FOR ANNOTATION FILE #######################
../bin/phen2dis_matcher.rb -m Hs_disease_phenotype.txt -t phenotype.hpoa -s 'annotation' -r true > mondo_to_omim_annot_with_match_percentages_rev
../bin/Db_comparer.rb -m Hs_disease_phenotype.txt -o OMIM_ALL_FREQUENCIES_diseases_to_genes_to_phenotypes.txt -r mondo.obo -l mondo_to_omim_annot_with_match_percentages_rev -k 'OMIM'| cut -f 2 > omim_equivalents_from_obo
...
########################## FOR OMIM FILE ############################
#../bin/phen2dis_matcher.rb -m Hs_disease_phenotype.txt -t OMIM_ALL_FREQUENCIES_diseases_to_genes_to_phenotypes.txt -s 'OMIM' -r true > mondo_to_omim_with_match_percentages_rev
#../bin/Db_comparer.rb -m Hs_disease_phenotype.txt -o OMIM_ALL_FREQUENCIES_diseases_to_genes_to_phenotypes.txt -r mondo.obo -l mondo_to_omim_with_match_percentages_rev -k 'OMIM'| cut -f 2 > omim_equivalents_from_obo
...
########################## FOR HPOS FROM OBO FILE ############################
#../bin/phen2dis_matcher.rb -m Hs_disease_phenotype.txt -t mondo.obo -s 'obo' -k 'HP:' -r true > mondo_to_HPO_with_match_percentages_rev
