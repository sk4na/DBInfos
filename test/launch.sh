...
########################## FROM NEW MONDO FOR OLD MONDO FILE #######################
../bin/phen2dis_matcher.rb -p ../processed_data/mondo.prof -t ../processed_data/mondo_new.prof > ../output_data/mondovsmondo_with_match_percentages
../bin/xygraph.R -d ../output_data/mondovsmondo_with_match_percentages -o 'graph_mondovsmondo' -x 2 -y 4
mv graph_mondovsmondo.pdf ../output_data/graph_mondovsmondo.pdf